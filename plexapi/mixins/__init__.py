...
class PlaylistEditMixins(ArtLockMixin, PosterLockMixin, SortTitleMixin, SummaryMixin, TitleMixin):
    pass
...
class ClipMixins(ArtUrlMixin, LogoUrlMixin, PosterUrlMixin, SquareArtUrlMixin):
    pass
...
class PhotoalbumMixins(
    RatingMixin, ArtMixin, LogoMixin, PosterMixin, SquareArtMixin, PhotoalbumEditMixins
):
    pass


class PhotoMixins(
    RatingMixin, ArtUrlMixin, LogoUrlMixin, PosterUrlMixin, SquareArtUrlMixin, PhotoEditMixins
):
    pass
...
class PlaylistMixins(
    SmartFilterMixin, ArtMixin, LogoMixin, PosterMixin, SquareArtMixin, PlaylistEditMixins
):
    pass
