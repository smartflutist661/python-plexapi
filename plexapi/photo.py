...
class Photoalbum(PlexPartialObject, PhotoalbumMixins):
...
@utils.registerPlexObject
class Photo(PlexPartialObject, Playable, PhotoMixins):
    ...
    def _getWebURL(self, base=None):
        ...
        return self._server._buildWebURL(
            base=base, endpoint="details", key=self.parentKey, legacy=1
        )
