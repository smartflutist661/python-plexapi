...
class Artist(Audio, ArtistMixins):
    ...
    def album(self, title):
        ...
        return self.section().get(
            title=title, libtype="album", filters={"artist.id": self.ratingKey}
        )
    ...
    def popularTracks(self):
        ...
        return self.section().search(
            libtype="track", filters=filters, sort="ratingCount:desc", limit=100
        )
...
@utils.registerPlexObject
class Track(Audio, Playable, TrackMixins):
